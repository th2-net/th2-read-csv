...
public class TransportCsvContentParser extends AbstractCsvContentParser<com.exactpro.th2.common.schema.message.impl.rabbitmq.transport.RawMessage.Builder> {
    public TransportCsvContentParser(Map<String, CsvFileConfiguration> configurationMap) {
